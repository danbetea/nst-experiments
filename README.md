...
- the input image is not the original content image, but rather a blend of uniform noise and the content image (i.e. a noise image correlated to some extent with the content image).
